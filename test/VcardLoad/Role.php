...
use Faker;
use Kigkonsult\PhpVcardMgr\Property\Role as Dto;
 ...
 *
 * ROLE-param = "VALUE=text" / language-param / pid-param / pref-param / type-param / altid-param / any-param
 * ROLE-value = text
 */
final class Role extends LoadBase
{
    /**
     * Use faker to populate new Role
     *
     * @return Dto
     */
