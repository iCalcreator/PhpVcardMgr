...
use Kigkonsult\PhpVcardMgr\Property\Key as Dto;
 ...
 */
final class Key extends LoadBase
{
    /**
     * Use faker to populate new Key
     *
     * @return Dto
     */
    public static function load() : Dto
    {
        ...
        return Dto::factory(
            (( self::URI === $valueType ) ? $faker->anyUri() : $faker->words( 6, true )),
            $parameters,
            $valueType
        );
    }
