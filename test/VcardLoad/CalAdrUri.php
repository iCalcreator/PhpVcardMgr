...
use Kigkonsult\PhpVcardMgr\Property\CalAdrUri as Dto;

/**
 * CALADRURI
 *
 * the calendar user address [RFC5545]
 * to which a scheduling request [RFC5546]
 ...
 * CALADRURI-value = URI
 */
final class CalAdrUri extends LoadBase
{
    /**
     * Use faker to populate new CalAdrUri
     *
     * @return Dto
     */
