...
use Faker;
use Kigkonsult\PhpVcardMgr\Property\Kind as Dto;
 ...
 * "individual" default
 */
final class Kind extends LoadBase
{
    /**
     * Use faker to populate new Kind
     *
     * @return Dto
     */
    public static function load() : Dto
    {
        ...
        return Dto::factory(
            $faker->randomElement( [ 'individual','group', 'org', 'location', 'X-' . $faker->word() ] ),
