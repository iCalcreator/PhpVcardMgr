...
use Kigkonsult\PhpVcardMgr\Property\Member as Dto;
 ...
 * MEMBER-value = URI
 */
final class Member extends LoadBase
{
    /**
     * Use faker to populate new Member
     *
     * @return Dto
     */
    public static function load() : Dto
    {
        ...
        return Dto::factory(
            $faker->randomElement( [ $faker->urnUuidUri(), $faker->mailtoUri() ] ),
            self::loadParameters(
